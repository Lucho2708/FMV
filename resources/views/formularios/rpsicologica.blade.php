                        ...
                        <div class="input-group-lg">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="2" class="form-control no-resize" name="descripcion"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="2" class="form-control no-resize" name="motivo_remision"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="2" class="form-control no-resize" name="recomendaciones"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
